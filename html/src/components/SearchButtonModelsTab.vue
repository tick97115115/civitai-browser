<template>
  <v-form>
    <v-container>
      ...
      <v-row>
        <v-col cols="12" md="8"> <v-text-field label="APIKEY"></v-text-field></v-col>
        <v-col cols="12" md="4"><v-checkbox label="NSFW"></v-checkbox></v-col
      ></v-row>
      <v-combobox
        v-model="select"
      ...
      ></v-combobox>
      <v-row>
        <v-col cols="12" md="4"><v-text-field label="Tag"></v-text-field></v-col>
        <v-col cols="12" md="8"><v-text-field label="Username"></v-text-field></v-col>
      </v-row>
      <v-row>
        <v-col cols="12" md="7"
          ><v-combobox label="Sort" :items="models_sort_items"></v-combobox
        ></v-col>
        <v-col cols="12" md="5"
          ><v-combobox label="Period" :items="models_period_items"></v-combobox
        ></v-col>
      </v-row>
      <v-row>
        <v-col cols="12" md="6"> <v-text-field label="Page Size"></v-text-field></v-col>
        <v-col cols="12" md="6"> <v-text-field label="Current Page"></v-text-field></v-col>
      </v-row>
      <div class="d-flex justify-space-evenly">
        <v-btn type="submit">Save</v-btn>
        <v-btn type="submit">Run</v-btn>
      </div>
    </v-container>
  </v-form>
</template>
...
<script setup>
import { ref } from 'vue'
import { model_types, models_request_sort, models_request_period } from '../models/models'
