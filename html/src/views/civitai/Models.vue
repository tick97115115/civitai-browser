      ...
      modelVersions: [
        {
          ...
          trainedWords: ['VSKnormal', 'VSKDress', 'VSKJacketless', 'VSKChristmas', 'VSKFace'],
          stats: {
            downloadCount: 988,
            ratingCount: 112,
            rating: 5,
